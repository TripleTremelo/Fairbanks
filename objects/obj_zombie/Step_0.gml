...
if instance_exists(obj_player) 
{
	...
	if !spewed && point_distance(x,y,obj_player.x,obj_player.y) < 50
	{
		play_sound(0,snd_zombie_spew,0,0.17,0.95,0.1,250,400,1,80)
...
if chasing
{
	speed=wave(0.87,max_spd,spd_change,0)
...
{
	dir_count=15
	if speed > 0 {sprite_index=spr_zombie_walk} else {sprite_index=spr_zombie_idle}
}


if hp <= 0
{
	play_sound(0,snd_zombie_splat,0,0.25,0.69,0.18,250,400,1,80)
	instance_destroy()
}