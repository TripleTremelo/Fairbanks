...
if spawn_chance > 84 && spawn_chance <= 93  {instance_create_layer(xx-10+random(20),y-86+random(170),"Main",obj_wolf)}
if spawn_chance > 93 && spawn_chance <= 100 {instance_create_layer(xx-10+random(20),y-86+random(170),"Main",obj_springer)}
