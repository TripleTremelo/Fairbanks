...
//   Turns blue when CRAFTED, turns RED when trying to craft but no materials. get 2 SFX, succesful crafitn and failing crafting.
//also a -5 on top or above the ITEM.
...
//TEXT CONTROLS.
set_text(fnt_chava_12,0.45,c_black,fa_left,fa_middle)
draw_text(1146,660,"[T] = Tent")
draw_text(1146,680,"[H] = Health")
draw_text(1146,700,"[B] = Bullets")

draw_set_color(c_red)
draw_set_alpha(red_flash)
draw_text(1145+random(2),659+random(2),"[T] = Tent")
draw_rectangle(1144,649,1276,710,1)
draw_rectangle(1143+random(2),648+random(2),1275+random(2),709+random(2),1)
